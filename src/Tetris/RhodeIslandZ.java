...
public class RhodeIslandZ implements MovingBlock {
	...
	public RhodeIslandZ(int initLeftmostID, Color blockColor) {
	...
	public void initSequence() {
		int[][] sequence = {{initLeftmostID,initLeftmostID+1,initLeftmostID-boardCols,initLeftmostID-boardCols-1},
				{initLeftmostID,initLeftmostID-boardCols,initLeftmostID-1,initLeftmostID-1+boardCols},
				{initLeftmostID,initLeftmostID-1,initLeftmostID+boardCols,initLeftmostID+boardCols+1},
